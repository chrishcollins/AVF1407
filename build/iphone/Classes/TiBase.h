...
// in simulator we redefine to format for Weather Developer console
...
{\
	NSString * exceptionName = [@"org.weather." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.weather";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeatherNativeItemNone = -1, 
	UIWeatherNativeItemSpinner = -2,
	UIWeatherNativeItemProgressBar = -3,
	
	UIWeatherNativeItemSlider = -4,
	UIWeatherNativeItemSwitch = -5,
	UIWeatherNativeItemMultiButton = -6,
	UIWeatherNativeItemSegmented = -7,
	
	UIWeatherNativeItemTextView = -8,
	UIWeatherNativeItemTextField = -9,
	UIWeatherNativeItemSearchBar = -10,
	
	UIWeatherNativeItemPicker = -11,
	UIWeatherNativeItemDatePicker = -12,
	
	UIWeatherNativeItemInfoLight = -13,
	UIWeatherNativeItemInfoDark = -14,
	
	UIWeatherNativeItemDisclosure = -15,
	
	UIWeatherNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Weather instances of
