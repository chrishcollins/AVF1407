...
/**
 The base class for all Weather modules
 */
...
/**
 Weather Platform calls this method on startup.
 */
-(void)startup;

/**
 Weather Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Weather Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Weather Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Weather Platform calls this method on resume.
 @param sender The sender of the event.
 */
